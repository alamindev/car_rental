...
@section('main-title') --::Add choose::--
@endsection
 
@section('main-content')
<form role="form" action="{{ route('store-choose') }}" method="post">
  {{ csrf_field() }}
  <div class="row">
    <div class="col-md-12">
      <div class="box box-danger">
        <div class="box-header">
          <h3 class="box-title pull-left">Add choose</h3>
        </div>
            ...
            <div class="col-md-12">
              <div class="box-body">
                <div class="form-group {{ $errors->has('title') ? 'is-invalid' : '' }}">
                  ...
                  <input type="text" name='title' class="form-control" id="title" placeholder="Write a choose title" value="{{ old('title') }}">
                ...
                <div class="form-group">
                  <input type="submit" class="btn btn-primary" value="Add choose">
                </div>
              </div>
            </div>
          </div>

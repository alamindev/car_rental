...
@section('main-content') 
 <form role="form" action="{{ route('loan-update',$edit->id) }}" method="post">
  {{ csrf_field() }}
  <div class="row">
        <div class="col-md-12"> 
          <div class="box box-danger">
            <div class="box-header">
            <h3 class="box-title pull-left">Edit Loan</h3>
                    ...
                    <div class="box-body">
                      ...
                      <div class="form-group {{ $errors->has('detail') ? 'is-invalid' : '' }}"> 
                       ...
                       <div class="form-group">
                        <input type="submit" class="btn btn-secondary" value="update Loan">
                      </div>
                    </div> 
                </div> 
              </div>

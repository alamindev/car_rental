...
@section('main-title') --::edit facility::--
@endsection
 
@section('main-content')
<form role="form" action="{{ route('facility-update',$edit->id) }}" method="post" enctype="multipart/form-data">
  {{ csrf_field() }}
  <div class="row">
    <div class="col-md-12">
      <div class="box box-danger">
        <div class="box-header">
          <h3 class="box-title pull-left">Edit facility</h3>
            ...
            <div class="col-md-12">
              <div class="box-body">
                <div class="form-group {{ $errors->has('icon') ? 'is-invalid' : '' }}">
                  <label for="title">facility Icon <span class="text-danger">*</span></label>
                ...
                <div class="form-group">
                  <input type="submit" class="btn btn-secondary" value="Update facility">
                </div>
              </div>
            </div>
          </div>

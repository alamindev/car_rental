             ...
             <form role="form" action="{{ route('post-logoandtitle') }}" method="post" enctype="multipart/form-data" >
              ...
              @endif
                <div class="form-group {{ $errors->has('title') ? 'is-invalid' : '' }}">
                  ...
                  <input type="text" name='title' class="form-control" id="title" placeholder="Enter Your header title" disabled>
              ...
              <div class="box-footer">
                <button type="submit" class="btn btn-primary" disabled>Add Title & Logo</button>
              </div>
            </form> 
            </div>
            <!-- /.box-body -->

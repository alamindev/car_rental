        ...
        <div class="col-md-4"> 
          <div class="box box-danger">
            <div class="box-header">
              <h3 class="box-title">Edit Logo  And Title</h3>
              <div class="box-tools pull-right">
                <button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
              </div>
            </div>
            <div class="box-body">
             <form role="form" action="{{ route('update-logoandtitle',$edit->id) }}" method="post" enctype="multipart/form-data">
              {{ csrf_field() }}
              <div class="box-body">
              @if(session('message'))
              ...
              @endif
                ...
                <div class="form-group"> 
                   <img src="{{ asset('uploads/logo/'.$edit->logo) }}" width="200" alt="avatar">
                </div> 
              </div> 
              <div class="box-footer">
                <button type="submit" class="btn btn-primary pull-left">Add Title & Logo</button>
                <a href="{{ route('logoandtitle') }}" class="btn btn-success pull-right" onclick="return confirm('Are you sure!')">Back</a>
              </div>
            </form> 
            </div>
            <!-- /.box-body -->
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                        ...
                        <a href="{{ route('show-logoandtitle',['id'=>$data->id]) }}" onclick="return confirm('Are You Sure Delete This! ')"> <i class="fa fa-trash delete"></i></a>
                   </td>
                  </tr>
                  @endforeach
                </tbody>

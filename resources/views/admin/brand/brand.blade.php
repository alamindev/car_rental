...
<div class="row">
  <div class="col-md-6">
    <div class="box box-danger">
      ...
      <div class="box-body">
        <form role="form" action="{{ route('post-brand') }}" method="post">
          {{ csrf_field() }}
          <div class="box-body">
            @if(session('message'))
    ...
    <div class="box  box-solid box-primary">
      ...
      <div class="box-body">
        <table class="table table-bordered" id="datatable">
          ...
          <tbody>
            @php $i= 1; 
@endphp @foreach($brand as $data)
            <tr>
              <td>{{ $i++ }}</td>
              <td>{{ $data->brand_name }}</td>
              <td>
                <a href="{{ route('edit-brand',$data->id) }}"> <i class="fa fa-edit edit"></i></a>
                <a href="{{ route('destroy-brand',$data->id) }}"> <i class="fa fa-trash delete"></i></a>
              </td>
            </tr>
            @endforeach
          </tbody>

...
@section('main-title') --::add new Review::--
@endsection
 
@section('main-content')
<form role="form" action="{{ route('review-add') }}" method="post" enctype="multipart/form-data">
  {{ csrf_field() }}
  <div class="row">
    <div class="col-md-12">
            ...
            <div class="col-md-12">
              <div class="box-body">
                <div class="form-group {{ $errors->has('title') ? 'is-invalid' : '' }}">
                  ...
                  <input type="text" name='title' class="form-control" id="title" placeholder="Write a review title">
                ...
                <div class="form-group {{ $errors->has('name') ? 'is-invalid' : '' }}">
                  ...
                  <input type="text" name='name' class="form-control" id="name" placeholder="Write a customer name">
                ...
                <div class="form-group {{ $errors->has('name') ? 'is-invalid' : '' }}">
                  ...
                  <input type="text" name='address' class="form-control" id="address" placeholder="Write a customer address">

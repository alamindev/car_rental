...
@section('main-title') --::Update Privacy::--
@endsection
 
@section('main-content')
<form role="form" action="{{ route('update-privacy') }}" method="post">
  {{ csrf_field() }}
  <div class="row">
    <div class="col-md-12">
      <div class="box box-danger">
        <div class="box-header">
          <h3 class="box-title pull-left">Update Privacy</h3>
        </div>
        <div class="clearfix"></div>
        <div class="box-body">
          @if(Session::has('message'))
          <p class="alert alert-success message text-center">Privacy Add successfully Complated!</p>
          @endif @if(Session::has('update'))
          <p class="alert alert-primary update text-center">Privacy Update Successfully Complated!</p>
          @endif
          <div class="row">
            <div class="col-md-12">
              <div class="box-body">
